...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 text-slate-500 hover:text-white hover:bg-slate-800 transition-all focus:outline-none">
        <X className="h-4 w-4" />
